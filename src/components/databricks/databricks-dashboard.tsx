...
const MODULES = [
  { href: DATABRICKS_ROUTES.notes, title: "Notes", icon: BookOpen },
  { href: DATABRICKS_ROUTES.practice, title: "Practice", icon: Terminal },
  { href: DATABRICKS_ROUTES.interview, title: "Interview", icon: Brain },
];
  ...
  return (
    <div className="space-y-8">
      <section className="panel p-6">
        <h1 className="text-2xl font-semibold tracking-tight">Databricks Lab</h1>
      ...
      <section className="panel p-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Delta Lake → Unity Catalog → workflows → practice → flashcards
        </p>
      </section>
    </div>
  );
