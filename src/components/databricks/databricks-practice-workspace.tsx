...
const tierBadge: Record<DatabricksPracticeQuestion["tier"], string> = {
  ...
  medium: "bg-rose-500/10 text-rose-500 ring-rose-500/20",
          ...
          <aside className="space-y-3 xl:max-h-[75vh] xl:overflow-y-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-border/70 bg-background/60 py-2.5 pl-10 pr-3 text-sm outline-none ring-rose-500/30 focus:ring-2"
              />
            </div>
