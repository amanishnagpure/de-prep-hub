...
const CONFIDENCE_STYLES: Record<InterviewConfidence, string> = {
  ...
  unsure: "bg-muted font-medium text-foreground ring-fuchsia-500/20",
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mx-auto max-w-3xl">
        <div className="min-h-[320px] rounded-3xl border border-border bg-gradient-to-br from-card via-card/90 to-fuchsia-500/5 p-8 shadow-xl">
          {!flipped ? (
            <div>
