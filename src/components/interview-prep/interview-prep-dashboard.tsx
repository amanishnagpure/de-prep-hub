...
const MODULES = [
  { href: INTERVIEW_PREP_ROUTES.notes, title: "Notes", icon: BookOpen },
  { href: INTERVIEW_PREP_ROUTES.practice, title: "STAR Drills", icon: MessageSquare },
  { href: INTERVIEW_PREP_ROUTES.interview, title: "Flashcards", icon: Brain },
];
  ...
  return (
    <div className="space-y-8">
      <section className="panel p-6">
        <h1 className="text-2xl font-semibold tracking-tight">Interview Hub</h1>
      ...
      <section className="panel p-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Behavioral & STAR → technical roundup → resume → negotiation → drills → flashcards
        </p>
      </section>
    </div>
  );
