...
export function PythonPracticeWorkspace({ questions, syncSelectionToUrl }: PythonPracticeWorkspaceProps) {
          ...
          <aside className="order-2 space-y-3 lg:order-1 lg:sticky lg:top-12 lg:max-h-[calc(100dvh-3rem)] lg:overflow-y-auto lg:overscroll-contain">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-border bg-background/60 py-2.5 pl-10 pr-3 text-sm outline-none ring-amber-500/30 focus:ring-2"
              />
            </div>
              ...
              {(Object.keys(tierLabels) as TierFilter[]).map((key) => (
                <button
                  ...
                  className={cn(
                    ...
                    tier === key
                      ? "bg-muted font-medium text-foreground ring-1 ring-amber-500/20"
