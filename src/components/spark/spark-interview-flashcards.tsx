...
const CONFIDENCE_STYLES: Record<InterviewConfidence, string> = {
  ...
  unsure: "bg-orange-500/10 text-orange-500 ring-orange-500/20",
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mx-auto max-w-3xl">
        <div className="min-h-[320px] rounded-3xl border border-border/70 bg-gradient-to-br from-card via-card/90 to-orange-500/5 p-8 shadow-xl">
          {!flipped ? (
            <div>
