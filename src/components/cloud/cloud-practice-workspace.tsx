...
const tierBadge: Record<CloudPracticeQuestion["tier"], string> = {
  basic: "bg-emerald-500/10 text-emerald-500 ring-emerald-500/20",
  medium: "bg-cyan-500/10 text-cyan-500 ring-cyan-500/20",
          ...
          <section className="rounded-2xl border border-border/70 bg-card/50 p-5 sm:p-6">
            ...
            <div className="mt-5">
              ...
              <textarea
                ...
                rows={6}
                className="w-full rounded-xl border border-border/70 bg-background/60 px-4 py-3 text-sm outline-none ring-cyan-500/30 focus:ring-2"
              />
            </div>
